...
private const val TAG = "XHMA-XposedEntry"
...
class XposedEntry : IXposedHookZygoteInit, IXposedHookLoadPackage {
    ...
    override fun handleLoadPackage(lpparam: XC_LoadPackage.LoadPackageParam) {
        if (lpparam.packageName == Constants.APP_PACKAGE_NAME) {
            ...
            hookAllConstructorAfter("com.xz.xhma.MyApp") {
                getFieldByDesc("Lcom/xz/xhma/MyApp;->isHooked:Z").setBoolean(it.thisObject, true)
            }
