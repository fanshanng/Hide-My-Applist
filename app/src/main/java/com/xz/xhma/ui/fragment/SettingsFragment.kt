...
import com.xz.xhma.databinding.FragmentSettingsBinding
import com.xz.xhma.common.CommonUtils
import com.xz.xhma.common.Constants
...
import com.xz.xhma.util.LangList
import com.xz.xhma.util.SuUtils
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            findPreference<Preference>("forceCleanEnv")?.setOnPreferenceClickListener {
                MaterialAlertDialogBuilder(requireActivity())
                    ...
                    .setMessage(R.string.settings_is_clean_env_summary)
                    .setPositiveButton(android.R.string.ok) { _, _ ->
                        val result = SuUtils.execPrivileged("rm -rf /data/misc/xhma*")
