...
import com.xz.xhma.BuildConfig
import com.xz.xhma.R
import com.xz.xhma.databinding.FragmentHomeBinding
import com.xz.xhma.data.fetchLatestUpdate
import com.xz.xhma.hmaApp
import com.xz.xhma.service.ConfigManager
import com.xz.xhma.service.PrefManager
import com.xz.xhma.service.ServiceClient
import com.xz.xhma.ui.activity.AboutActivity
import com.xz.xhma.ui.util.ThemeUtils.getColor
import com.xz.xhma.ui.util.ThemeUtils.themeColor
import com.xz.xhma.ui.util.makeToast
import com.xz.xhma.ui.util.navController
import com.xz.xhma.ui.util.setupToolbar
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.backupConfig.setOnClickListener {
            backupSAFLauncher.launch("XHMA_Config.json")
        }
    ...
    override fun onStart() {
        ...
        if (serviceVersion != 0) {
            if (serviceVersion < com.xz.xhma.common.BuildConfig.SERVICE_VERSION) {
