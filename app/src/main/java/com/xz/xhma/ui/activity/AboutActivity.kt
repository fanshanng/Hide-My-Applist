package com.xz.xhma.ui.activity
...
class AboutActivity : AbsAboutActivity() {
    ...
    override fun onItemsCreated(items: MutableList<Any>) {
        ...
        items.add(Contributor(R.drawable.cont_author, "\uD835\uDD93\uD835\uDD9A\uD835\uDD91\uD835\uDD91\uD835\uDD95\uD835\uDD99\uD835\uDD97", "Original developer", "https://github.com/Dr-TSNG"))
        items.add(Line())
        ...
        items.add(Line())
        items.add(Contributor(R.drawable.cont_icon_designer, "Icon Designer", "Icon designer", "http://www.coolapk.com/u/1560270"))
        items.add(Line())
        ...
        items.add(Card("Github\nhttps://github.com/fanshanng/Hide-My-Applist"))
